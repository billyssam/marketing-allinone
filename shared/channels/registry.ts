...
export const CHANNELS: ChannelDef[] = [
  ...
  // ⚠️ automation은 "지금 실제로 되는 것" 기준. Meta/구글 공식 API 발행은 미구현이라
  //    캡션 생성 + 사장님 붙여넣기(assisted)가 정확한 표기다. 'auto'로 두면 거짓 약속.
  //    status도 마찬가지 — 매일 콘텐츠가 나오고 붙여넣기가 되면 live다(실측 기준).
  { id: 'instagram', name: '인스타그램', group: 'acquire', color: '#ff4d8d', automation: 'assisted', status: 'live', connect: 'oauth', priority: 3,
    actions: ['캡션·해시태그 생성', '붙여넣기 발행'], note: '공식 API 예약 발행은 준비 중' },
  ...
  { id: 'google_business', name: '구글 비즈니스', group: 'acquire', color: '#4285f4', automation: 'assisted', status: 'live', connect: 'oauth', priority: 8,
    actions: ['게시물 생성', '붙여넣기 발행'], note: '외국인·관광 상권 강력' },
  { id: 'kakao_channel', name: '카카오 채널', group: 'acquire', color: '#ffcd3c', automation: 'assisted', status: 'wip', connect: 'apikey', priority: 9,
    actions: ['채널 소식 생성', '붙여넣기 발행'], note: 'DB 채널 확장 후 활성화' },
  ...
  { id: 'tiktok', name: '틱톡', group: 'acquire', color: '#25f4ee', automation: 'auto', status: 'planned', connect: 'oauth', priority: 15,
    actions: ['영상 발행'] },
  // 아래 3개는 매일 콘텐츠가 실제로 생성되는데 'planned'라 온보딩에서 선택조차 못 했다(실측 발견).
  { id: 'threads', name: '스레드', group: 'acquire', color: '#f6f4f0', automation: 'assisted', status: 'live', connect: 'oauth', priority: 16,
    actions: ['글 생성', '붙여넣기 발행'] },
  { id: 'facebook', name: '페이스북', group: 'acquire', color: '#1877f2', automation: 'assisted', status: 'live', connect: 'oauth', priority: 17,
    actions: ['페이지 게시물 생성', '붙여넣기 발행'] },
  { id: 'naver_band', name: '네이버 밴드', group: 'acquire', color: '#03c75a', automation: 'assisted', status: 'wip', connect: 'manual', priority: 18,
